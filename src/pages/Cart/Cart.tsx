        ...
        {extendedPurchases.length > 0 ?
                ...
                {extendedPurchases?.map((purchase, index) => (
                  ...
                  >
                    <div className='col-span-6'>
                      <div className='flex'>
                        <div className='flex flex-shrink-0 items-center justify-center pr-3'>
                          <input type='checkbox' className='h-5 w-5 accent-orange' checked={purchase.checked}
          ...
          : (
            <div className='text-center'>
              <img src='https://fileinfo.com/img/ss/xl/jpg_44-2.jpg' alt='no purchase' className='mx-auto h-24 w-24' />

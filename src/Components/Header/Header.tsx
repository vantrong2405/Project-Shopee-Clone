        ...
        <div className='flex justify-end'>
          ...
          {!isAuthenicated &&
            <div className='flex items-center mx-4'>
              <Link className='block text-white hover:opacity-80' to={path.register}>Register</Link>
              <div className='border-r-2 h-4 border-white mx-2'></div>
              <Link className='block text-white hover:opacity-80' to={path.login}>Login</Link>
            </div>
          }
        </div>
